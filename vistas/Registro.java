...
public class Registro extends javax.swing.JFrame {
    ...
    public Registro() {
        ...
        this.controlador = new UsuariosController();
        
        setLocationRelativeTo(null); // Centrar la ventana
        setTitle("Registro de Usuario"); // Establecer título de la ventana
    }
    ...
    // Validar el correo electrónico para verificar el arroba (@)
    if (!correo.contains("@")) {
    ...
    try {
     ...
     private boolean isCorreoExistente(String correo) {
